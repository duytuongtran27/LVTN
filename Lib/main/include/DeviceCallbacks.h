...
{
public:
    static AppDeviceCallbacksDelegate & Instance()
    {
        static AppDeviceCallbacksDelegate instance;
        return instance;
    }
    ...
    AppDeviceCallbacksDelegate * mDelegate = nullptr;
    void SetAppDelegate(AppDeviceCallbacksDelegate * delegate) { mDelegate = delegate; }
    AppDeviceCallbacksDelegate * GetAppDelegate() { return mDelegate; }
};
