...
public:
    ...
    static const int kDeviceVendorNameSize     = 32;
    ...
    Device(const char * szDeviceName, const char * szLocation, const char * szVendorName);
    ...
    inline char * GetVendorName() { return mVendorName; };
...
private:
    ...
    char mVendorName[kDeviceVendorNameSize];
